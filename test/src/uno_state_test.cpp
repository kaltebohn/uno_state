...
TEST(StateTransitionTest, SubmissionOfDrawnCard) {
  ...
  UnoState src_state{
      ...
      std::array<int, UnoConsts::kNumOfPlayers>{0, 1, 2, 3},
      std::array<int, UnoConsts::kNumOfPlayers>{},
      ActionType::kSubmissionOfDrawnCard,
      3,
      0,
      true,
      table_card.getColor(),
...
TEST(StateTransitionTest, WildShuffleHandsSubmission) {
  ...
  EXPECT_EQ(dst_state.getCurrentActionType(), ActionType::kColorChoice);
...
/*
  ...
  期待する出力: {青, 緑, 赤, 黄色}。
*/
TEST(legalActionsTest, ColorChoice) {
  Card table_card{Card::kWild};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
  ...
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)Color::kBlue), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)Color::kGreen), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)Color::kRed), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)Color::kYellow), legal_actions.end());
}
...
/*
  ...
  期待する出力: {True, False}。
*/
TEST(legalActionsTest, Challenge) {
  Card table_card{Card::kWildDraw4};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
  ...
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)true), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)false), legal_actions.end());
}
...
/*
  ...
  期待する出力: {空のカード, 引いたカード}。
*/
TEST(legalActionsTest, SubmissionOfDrawnCard) {
  Card table_card{Card::kBlueZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
  ...
  EXPECT_EQ(legal_actions.size(), 2);
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)(Card{})), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)(drawn_card)), legal_actions.end());
}
...
/*
  ...
  期待する出力: {空のカード}。
*/
TEST(legalActionsTest, SubmissionOfDrawnCardNothing) {
  Card table_card{Card::kGreenZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
...
*/
TEST(legalActionsTest, SubmissionOfDrawnCardOnUNO) {
  Card table_card{Card::kBlueZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
...
*/
TEST(legalActionsTest, SubmissionMultiple) {
  Card table_card{Card::kBlueZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
  ...
  EXPECT_EQ(legal_actions.size(), 4);
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)(Card::kBlueOne)), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)(Card::kBlueDrawTwo)), legal_actions.end());
  EXPECT_NE(std::find(legal_actions.begin(), legal_actions.end(), (Action)(Card::kGreenZero)), legal_actions.end());
}
...
*/
TEST(legalActionsTest, SubmissionMultipleOnUno) {
  Card table_card{Card::kBlueZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
...
/*
  ...
  期待する出力: {空のカード}。
*/
TEST(legalActionsTest, SubmissionNothing) {
  Card table_card{Card::kBlueZero};
  Cards deck{allCards()};
  deck.erase(std::find(deck.begin(), deck.end(), table_card));
...
/*
  ...
  期待する出力: {}。
*/
TEST(legalActionsTest, AlreadyFinished) {
  // TODO
}
