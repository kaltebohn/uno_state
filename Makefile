...
$(TEST_OUTDIR)/card_test:	$(TEST_SRCDIR)/card_test.cpp $(OBJDIR)/action.o $(OBJDIR)/card.o
	$(CC) $(TEST_CFLAGS) -o $@ $^

$(TEST_OUTDIR)/submission_test:	$(TEST_SRCDIR)/submission_test.cpp $(OBJDIR)/action.o $(OBJDIR)/card.o
	$(CC) $(TEST_CFLAGS) -o $@ $^
