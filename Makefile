...
$(TEST_OUTDIR)/card_test:	$(TEST_SRCDIR)/card_test.cpp
	$(CC) $(TEST_CFLAGS) -o $@ $^

$(TEST_OUTDIR)/submission_test:	$(TEST_SRCDIR)/submission_test.cpp
	$(CC) $(TEST_CFLAGS) -o $@ $^


$(TEST_OUTDIR)/uno_state_test:
#$(TEST_OUTDIR)/uno_state_test:	$(TEST_SRCDIR)/uno_state_test.cpp $(OBJDIR)/uno_state.o
#	$(CC) $(TEST_CFLAGS) -o $@ $^
